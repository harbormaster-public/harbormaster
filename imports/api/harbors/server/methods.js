...
async function update_harbor (lane, values) {
  try {
...
async function render_input (lane, manifest) {
...
async function render_work_preview (
  lane, manifest
) {
...
async function add_harbor_to_depot (git_url) {
